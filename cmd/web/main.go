...
import (
	...
	"golangs.org/snippetbox/pkg/pkg/models/mysql"
...
func main() {
	...
	dsn := flag.String("dsn", "web:pass@/test?parseTime=True", "Название MySQL источника даных")
	flag.Parse()
	...
	infoLog.Printf("Zapusk servear na %s", *addr)
